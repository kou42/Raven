...
状態: Phase 1 実装中（InputText / InputNumberの操作確認済み、Font/IME全項目は未完了）。OS Window基盤はPR #247で実装・動作確認済み、独自UIの論理Window / Multi-Viewportは未完了
...
## 現状の基盤（UI: 2026-09-21、OS Window: 2026-09-22 コード・動作確認）
...
| 5 | TreeView / Table | 実装中（TreeView基礎・Demo・縦Scroll/Scrollbar・回帰テスト追加、実行未検証／Table基礎・Demo・回帰テスト追加、実行未検証） | Hierarchy相当の選択・展開、表の列・Scroll・基本操作 |
